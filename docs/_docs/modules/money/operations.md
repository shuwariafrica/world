...
The [[world.money.Money Money]] type represents monetary values with type-safe operations.
...
[[world.money.Money]] values expose two properties:
...
[[world.money.Money]] integrates with the [[world.format.Formatter]] typeclass:
...
See [[world.money.Money]] for the complete API documentation.
