...
object CldrParser:
  ...
  private def parseLanguageScriptAssociations(cldrDir: File): Map[String, Set[String]] =
    ...
    result.toMap
  end parseLanguageScriptAssociations
